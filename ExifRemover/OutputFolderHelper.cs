...
namespace ExifRemover
{
    class OutputFolderHelper
    {
        ...
        {            
            if (folder == TranslateHelper.Translate("Subfolder of Image")
                || folder == TranslateHelper.Translate("Overwrite Images")
                || folder == TranslateHelper.Translate("Same Folder of Image")
        ...
        public static void LoadOutputFolders()
        {
            ...
            try
            {
                frmMain.Instance.cmbOutputDir.SelectedIndex = Properties.Settings.Default.OutputFolderIndex;
            }
            catch { }
        }
    }
