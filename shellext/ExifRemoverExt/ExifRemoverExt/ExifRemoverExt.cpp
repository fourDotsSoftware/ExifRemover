// ExifRemoverExt.cpp : Implementation of DLL Exports.
...
public :
	...
	DECLARE_REGISTRY_APPID_RESOURCEID(IDR_ExifRemoverEXT, "{A4C41B8C-24C1-4ACC-A8F7-2040943D9FA1}")
};
...
STDAPI DllRegisterServer(void)
{
    ...
    if ( 0 == (GetVersion() & 0x80000000UL) )
        ...
        lRet = reg.SetValue ( _T("ExifRemoverExt extension"), 
                              _T("{B79D2F2C-42F6-48E3-9FBE-0E2C76CC4422}") );
...
STDAPI DllUnregisterServer(void)
{
    ...
    if ( 0 == (GetVersion() & 0x80000000UL) )
        ...
        if ( ERROR_SUCCESS == lRet )
            {
            lRet = reg.DeleteValue ( _T("{B79D2F2C-42F6-48E3-9FBE-0E2C76CC4422}") );
            }
        }
